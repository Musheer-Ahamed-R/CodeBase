...
//
      ...
      tree.setLChild(new Node(7, null, null));
      tree.setRChild(new Node(2, null, null));

      tree.getLChild().setLChild(new Node(3, null, null));
      tree.getLChild().setRChild(new Node(5, null, null));
      tree.getRChild().setLChild(new Node(1, null, null));
      tree.getRChild().setRChild(new Node(30, null, null));
//
