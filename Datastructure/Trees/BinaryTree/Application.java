...
*/
      ...
      //System.out.println(OddEvenDiff.findOddEvenDiff(tree, true));

      //Node constructTree = ConstructFromInOrderPreOrder.constructFromInOrderPreOrder(inOrder, preOrder, 0, inOrder.length-1);
      //levelOrder(constructTree);

      /*Node constructTree = ConstructFromPreOrder.constructFromPreOrder(pre, preLN);
      levelOrder(constructTree);*/

      // TreeToDLL.treeToDLL(tree2);
      // TreeToDLL.print(TreeToDLL.curr);
